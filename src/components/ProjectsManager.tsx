  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-200">
        ...
        <div className="flex items-center gap-2 flex-1 max-w-md justify-end">
          ...
          <div className="relative flex-1">
            ...
            <input
              ...
              className="w-full pl-8 pr-3 py-1.5 bg-slate-50 border border-slate-200 rounded-xl text-xs text-slate-900 placeholder-slate-400 focus:bg-white focus:border-[#0055FF] outline-none transition-all"
            />
            {searchQuery && (
              <button
          ...
          <select
            ...
            className="px-2.5 py-1.5 bg-slate-50 border border-slate-200 rounded-xl text-xs text-slate-700 font-medium focus:bg-white focus:border-[#0055FF] outline-none shrink-0"
          >
      ...
      {filteredProjects.length === 0 ? (
        <div className="bg-white rounded-2xl border border-slate-200/80 p-12 text-center space-y-3 shadow-studio-sm max-w-md mx-auto">
          ...
          {paginatedProjects.map((project) => {
            ...
            return (
              <div
                ...
                className="bg-white rounded-2xl border border-slate-200/80 shadow-studio-sm hover:shadow-studio transition-all overflow-hidden flex flex-col justify-between group"
              >
                <div>
                  {/* Thumbnail Banner */}
                  <div 
                  ...
                  <div className="p-4 space-y-2">
                    ...
                    <h4 
                      onClick={() => onSelectProject(project)}
                      className="font-bold text-slate-900 text-sm leading-snug line-clamp-2 hover:text-[#0055FF] transition-colors cursor-pointer font-['Outfit',sans-serif]"
                    >
                      {project.title}
                    </h4>
