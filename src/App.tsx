      ...
      <footer className="mt-auto border-t border-slate-200/80 bg-white py-5 text-xs text-slate-400">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row items-center justify-between gap-3">
          <div className="flex items-center gap-2">
            <span className="font-bold text-slate-800 font-['Outfit',sans-serif]">ALPHABIT</span>
            <span>&bull;</span>
            <span>Sistema Administrativo de Contenidos</span>
          </div>
          <div className="flex items-center gap-4 text-[11px]">
            <span className="text-slate-500">Conectado a /api/projects</span>
            <span>&bull;</span>
            <span>Sesión protegida con 2FA</span>
          </div>
        </div>
      </footer>
